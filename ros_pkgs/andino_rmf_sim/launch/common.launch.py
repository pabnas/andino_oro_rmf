...
def generate_launch_description():
    ...
    map_arg = DeclareLaunchArgument('map_path', default_value=os.path.join(get_package_share_directory('andino_rmf_maps'), 'maps', 'andino_office', 'andino_office.building.yaml'))
